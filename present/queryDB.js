...
exports.getImages = function (req, res){
    ...
    var resImages = [];
    var queryStr = "select query,img_src,text,entry_point,photoby from pictures p,quotes q where p.selected=true and q.selected=true and p.query=q.topic and p.query <> '" + urlQuery.topic + "' order by id;";
